		...
		<el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
			<el-form :model="queryParams" ref="queryForm" :inline="true">
				<el-row :gutter="35">
					...
					<el-button type="primary" plain icon="ele-Search" @click="handleQuery" v-auth="'bD_Department:page'"> 查询
					</el-button>
					<el-button type="primary" icon="ele-Plus" @click="openAddBD_Department" v-auth="'bD_Department:add'"> 新增
					</el-button>
				</el-row>
			</el-form>
		</el-card>
		<el-card shadow="hover" style="margin-top: 8px">
			<el-table :data="tableData" style="width: 100%" v-loading="loading" tooltip-effect="light" row-key="id"
				...
				<el-table-column label="操作" width="140" align="center" fixed="right" show-overflow-tooltip=""
					v-if="auth('bD_Department:edit') || auth('bD_Department:delete')">
					<template #default="scope">
						<el-button icon="ele-Edit" size="small" text="" type="primary"
							@click="openEditBD_Department(scope.row)" v-auth="'bD_Department:edit'"> 编辑 </el-button>
						<el-button icon="ele-Delete" size="small" text="" type="primary"
							@click="delBD_Department(scope.row)" v-auth="'bD_Department:delete'"> 删除 </el-button>
					</template>
				</el-table-column>
			</el-table>
			...
			<editDialog ref="editDialogRef" :title="editBD_DepartmentTitle" @reloadTable="handleQuery" />
		</el-card>
	</div>
</template>
